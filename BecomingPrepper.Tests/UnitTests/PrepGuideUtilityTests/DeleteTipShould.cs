...
namespace BecomingPrepper.Tests.UnitTests.PrepGuideUtilityTests
{
    public class DeleteTipShould
    {
        ...
        {
            Action invalidArgumentsTest = () => _prepGuideUtility.Delete(ObjectId.Empty, _fixture.Create<string>());
        ...
        {
            Action invalidArgumentsTest = () => _prepGuideUtility.Delete(ObjectId.GenerateNewId(), string.Empty);
            invalidArgumentsTest.Should().Throw<ArgumentNullException>("Invalid Parameters Supplied");
        }
        ...
        {
            _prepGuideUtility.Delete(_fixture.Create<ObjectId>(), _fixture.Create<string>());
